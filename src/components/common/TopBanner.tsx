...
import { X, PhoneCall, Info } from "lucide-react";
...
export default function TopBanner() {
    ...
    return (
        <div ref={bannerRef} className="relative isolate flex items-center gap-x-6 overflow-hidden bg-slate-900 px-6 py-2.5 sm:px-3.5 sm:before:flex-1 animate-in fade-in slide-in-from-top duration-500 sticky top-0 z-50">
            {/* Background pattern */}
            <div
            ...
            >
                <div
                    className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-primary to-secondary opacity-20"
                    style={{
                        clipPath:
