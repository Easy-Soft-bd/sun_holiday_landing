...
export default function TopBanner({ adminUser = null }: TopBannerProps) {
    ...
    return (
        <div ref={bannerRef} className={`relative isolate flex items-center gap-x-6 overflow-hidden ${adminUser ? 'bg-primary' : 'bg-slate-900'} px-4 py-2 sm:px-6 sm:py-2.5 sm:before:flex-1 animate-in fade-in slide-in-from-top duration-500 sticky top-0 z-50 transition-colors`}>
            {/* Background pattern */}
            <div
