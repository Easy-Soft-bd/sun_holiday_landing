...
import { Form, Input, Button, Select, DatePicker, InputNumber, Upload, Space, message, Card, Divider } from 'antd';
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      const formattedValues = {
        ...
        gallery: values.gallery || [], // This would ideally be an array of URLs from an upload handler
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Form
        ...
        layout="vertical"
        onFinish={onFinish}
        initialValues={{ status: 'Draft', category: 'Domestic' }}
      >
